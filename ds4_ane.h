 ...
 * Core ML support. */
/* The typed job queue (campaign phase 2.1) is NOT built. Its declarations
 * lived here for a while with no definitions, which is worse than absent: a
 * header that promises ds4_ane_job_begin() invites a call site to be written
 * against it. It comes back when A2.1 is implemented. */
