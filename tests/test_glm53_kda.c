 ...
 * tiled kernel with no numeric coverage. This covers the production shape.
 *
...
int main(void) {
     ...
     * heads and so never crosses the tiled gate, leaving
     * kernel_glm_indexer_scores_tiled with no numeric coverage at all. */
