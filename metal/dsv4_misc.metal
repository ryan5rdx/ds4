...
template [[host_name("kernel_dsv4_indexer_scores_llt")]]
kernel kernel_dsv4_llt_t kernel_dsv4_indexer_scores_llt_impl<8, 8>;
/* Same NK=64 shape, with sq/sw/sqk aliased over dead K staging storage.
 * 16384 B instead of 20512 -> 2 threadgroups resident per 32 KiB core. */
template [[host_name("kernel_dsv4_indexer_scores_llt_tight")]]
kernel kernel_dsv4_llt_t kernel_dsv4_indexer_scores_llt_impl<8, 8, true>;
