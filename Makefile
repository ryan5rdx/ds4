...
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_distributed_rdma.o ds4_rdma_verbs.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
else
...
ds4_distributed.o: ds4_distributed.c ds4_distributed.h ds4_distributed_rdma.h ds4.h ds4_ssd.h
...
tests/test_engine_mgpu_placement: tests/test_engine_mgpu_placement.o ds4_cpu_test_hooks.o ds4_distributed.o ds4_distributed_rdma.o ds4_rdma_verbs.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
